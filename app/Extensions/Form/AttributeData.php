...
use App\Extensions\FieldTypes\Repeater\RepeaterType;
use App\Extensions\FieldTypes\RepeaterGroup;
use App\Extensions\FieldTypes\RepeaterGroup\RepeaterGroupType;
...
class AttributeData
{
    protected array $fieldTypes = [
        ...
        Repeater::class => RepeaterType::class,
        RepeaterGroup::class => RepeaterGroupType::class
    ];
