    ...
    <div class="flex flex-col md:flex-row gap-16 mt-4">
        <div class="flex gap-3">
            <div class="flex flex-col gap-3">
                <div class="border max-w-24 border-gray-500/30 rounded overflow-hidden cursor-pointer">
                    <img src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/card/productImage.png" alt="Thumbnail 1">
                </div>
                <div class="border max-w-24 border-gray-500/30 rounded overflow-hidden cursor-pointer">
                    <img src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/card/productImage2.png" alt="Thumbnail 2">
                </div>
                <div class="border max-w-24 border-gray-500/30 rounded overflow-hidden cursor-pointer">
                    <img src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/card/productImage3.png" alt="Thumbnail 3">
                </div>
                <div class="border max-w-24 border-gray-500/30 rounded overflow-hidden cursor-pointer">
                    <img src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/card/productImage4.png" alt="Thumbnail 4">
                </div>
            </div>

            <div class="border border-gray-500/30 max-w-100 rounded overflow-hidden">
                <img src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/card/productImage.png" alt="Selected product">
            </div>
        </div>
        ...
        <div class="text-sm w-full md:w-1/2">
            ...
            <div class="flex items-center mt-10 gap-4 text-base">
                ...
                <button class="w-full py-3.5 font-medium bg-indigo-500 text-white hover:bg-indigo-600 transition cursor-pointer">
                    Buy now
                </button>
            </div>
        </div>
